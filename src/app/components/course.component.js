...
function Course(props) {
    ...
    return (
        <div className="w-full relative max-w-lg select-none">
            <div className={`bg-gradient-140-${gradient} p-6 pb-16 rounded-xl text-white shadow-xl flex justify-center`}>
                ...
                <div className="w-14 pl-2">
                    <CirclePercentage className="w-full max-w-xs text-white float-right" percentage={props.progress} strokeWidth="5" />
                </div>
            </div>
            <div className="float-right mr-6 bg-white text-gray-700 px-4 py-3 w-9/12 max-w-xs -mt-10 rounded-xl flex justify-between text-center shadow-2xl">
                <div className="w-5/12">
                    <div className="font-bold text-xl">{props.lessonCount}</div>
                ...
                <div className="w-5/12">
                    <div className="font-bold text-xl">{props.cardCount}</div>
